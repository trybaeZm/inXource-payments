...
const PhoneVerification = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    if (!companyInfo) {
      Swal.fire('Error', 'Company information is missing.', 'error');
      setLoading(false);
      return;
    }
    PaymentService.getCustomerByPhoneAndBusiness({
      phone: phone,
      ...
      .catch((error) => {
        ...
        Swal.fire('Error', 'An error occurred while checking your phone number.', 'error');
      })
      .finally(() => {
        setLoading(false);
      });
